...
## Purpose
Own the full pattern domain: the Pattern Store, lifecycle (draft→approved→deprecated), RCA, codebook reconciliation, explainability, and the human-approval workflow. Contains no ML.
