...
## Purpose
Real-time correlation: stateful matching of live enriched alarms against approved patterns and the codebook; confidence scoring; conflict resolution; tag root cause + child alarms; persist incidents.
