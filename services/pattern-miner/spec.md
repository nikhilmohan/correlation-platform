...
## Purpose
ML execution only: assemble trail-scoped, session-windowed transactions and run PrefixSpan (PySpark) to discover frequent ordered alarm sequences with support/confidence/lift. Holds no pattern state.
