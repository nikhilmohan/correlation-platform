...
## Purpose
Sole owner of the topology graph in Apache AGE. Ingest topology.raw, lift flat records into the typed multi-layer graph, version snapshots, expose query APIs, emit topology.changed.
