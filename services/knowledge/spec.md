...
## Purpose
Authoritative versioned store for domain knowledge: propagation templates, fault-origin types, trail policy, and Phase-2 model parameters. Served via API; emits knowledge.updated.
