...
These are not exercised by the unit gate (no live broker); the decode/route/emit logic they
drive is unit-tested in :mod:`noise_filter.ingest`, :mod:`noise_filter.emit`, and
:mod:`noise_filter.pipeline`. Kept minimal and side-effect-free at import time.
"""
...
class TransactionProducer:
    """Idempotent producer for ``transactions.clean`` (and DLQ via :class:`DlqPublisher`)."""
